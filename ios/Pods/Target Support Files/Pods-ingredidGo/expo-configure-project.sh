...
with_node \
  ...
  --target "/Users/vivianli/ingrediGo/ios/Pods/Target Support Files/Pods-ingredidGo/ExpoModulesProvider.swift" \
   \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser" "ocr-module"
